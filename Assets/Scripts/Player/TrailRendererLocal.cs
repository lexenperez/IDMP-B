...
public class TrailRendererLocal : MonoBehaviour
{
    ...
    // Source: https://forum.unity.com/threads/trail-renderer-local-space.97756/
    ...
    [SerializeField] private float distIncrement = 0.1f;      // How far should the object move before leaving a new trail point
    private Vector3 lastPosition;           // internal log of last trail point... could also use myLine.GetPosition(myLine.numPositions)

    [SerializeField] private bool limitTrailLength = false;   // Toggle this to make trail be a finite number of segments
    [SerializeField] private int maxPositions = 10;           // Set the number of segments here

    private bool canEmitTrail = false;
    public void SetEmit(bool canEmit)
    {
        canEmitTrail = canEmit;
    }
