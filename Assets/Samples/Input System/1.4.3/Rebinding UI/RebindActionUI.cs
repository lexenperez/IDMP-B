...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            // Disable the rebind
            action.Disable();
            Debug.Log("Before: " + action.bindings[bindingIndex]);
            InputBinding prevBinding = action.bindings[bindingIndex];
        ...
        private void SwapDuplicateBindings(InputBinding prevBinding, InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            // Cache a reference to the current binding.
            InputBinding newBinding = action.bindings[bindingIndex];
            //Debug.Log("Key Pressed: " + newBinding);
            ...
            //        {
            //            Debug.Log("Duplicate finding found: " + newBinding.effectivePath);
            //        }
        }
